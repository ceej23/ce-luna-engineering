...
run v2-tier2-single PASS "$root/assessment/fixtures/v2-tier2-single"
run v2-tier3-multiple PASS "$root/assessment/fixtures/v2-tier3-multiple"
run v2-sol-only FAIL "$root/assessment/fixtures/v2-sol-only"
run v2-overlap FAIL "$root/assessment/fixtures/v2-overlap"
run v2-maker-reviewer FAIL "$root/assessment/fixtures/v2-maker-reviewer"
run v2-missing-evidence UNVERIFIED "$root/assessment/fixtures/v2-missing-evidence"
run v2-inconsistent-integration UNVERIFIED "$root/assessment/fixtures/v2-inconsistent-integration"
run v2-missing-sol UNVERIFIED "$root/assessment/fixtures/v2-missing-sol"
run v2-sensitive UNVERIFIED "$root/assessment/fixtures/v2-sensitive"
run v2-unknown-run UNVERIFIED "$root/assessment/fixtures/v2-unknown-run"
run v2-exception-field UNVERIFIED "$root/assessment/fixtures/v2-exception-field"
...
summary_check v2-pass PASS conformant info "$root/assessment/fixtures/v2-tier2-single" "$tmp/summary/v2-pass.tsv"
summary_check v2-sol-only FAIL 'control-failure;required-maker-missing' info "$root/assessment/fixtures/v2-sol-only" "$tmp/summary/v2-sol-only.tsv"

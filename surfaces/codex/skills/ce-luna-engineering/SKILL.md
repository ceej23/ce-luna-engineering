...
| **Tier 2: Standard** | Ordinary mutation that is neither Small nor High-risk | One or more bounded makers, at least one independent integrated reviewer, one remediation/re-review allowance, one broad Sol check | 60 minutes; scale with independently bounded units and budget |
